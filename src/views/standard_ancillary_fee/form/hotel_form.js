  ...
  const onSubmitFee = (values, id) => {
      let payloadDomestic = {
        ...
        domestic_hotel: {
          ...
          amount: values.domestic_hotel == "amount" ? values.domestic_hotel_amount : null,
          percent:values.domestic_hotel == "amount" ? null : values.domestic_hotel_percent,
          charge_type_id:values.domestic_hotel == "amount" ? values.domestic_hotel_amount_type : null,
          is_tax_inclusive:values.domestic_hotel == "amount" ? null : values.domestic_hotel_tax_include,
          is_hidden: true,
          is_included: false,
        },
        domestic_refund: {
        ...
        international_hotel: {
          ...
          currency_id:"ccd96b44-3053-4469-9c55-0b7163a01d34",
          amount: values.international_hotel == "amount" ? values.international_hotel_amount : null,
          percent:values.international_hotel == "amount" ? null : values.international_hotel_percent,
          charge_type_id:values.international_hotel == "amount" ? values.international_hotel_amount_type : null,
          is_tax_inclusive:values.international_hotel == "amount" ? null : values.international_hotel_tax_include,
          is_hidden: true,
          is_included: false,
        },
        international_refund: {
