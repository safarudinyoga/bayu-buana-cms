    ...
    try {
      if(formId) {
        ...
        setInitialForm({
          ...
          domestic_rfp: checkprocessingType(data.domestic_frp.charge_type_id),
          domestic_rfp_fee_tax_id: data.domestic_frp.fee_tax_type_id,
          domestic_rfp_amount: data.domestic_frp.amount,
          domestic_rfp_amount_type: data.domestic_frp.charge_type_id,
          domestic_rfp_percent: data.domestic_frp.percent,
          domestic_rfp_tax_include: data.domestic_frp.is_tax_inclusive,
          ...
          international_rfp: checkprocessingType(data.international_frp.charge_type_id),
          international_rfp_fee_tax_id: data.international_frp.fee_tax_type_id,
          international_rfp_amount: data.international_frp.amount,
          international_rfp_amount_type: data.international_frp.charge_type_id,
          international_rfp_percent: data.international_frp.percent,
          international_rfp_tax_include: data.international_frp.is_tax_inclusive,
