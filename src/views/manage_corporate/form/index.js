...
>>>>>>> c685cab72de341c5fb664fbf15578e9048597469
              ...
              <Nav variant="pills" className="flex-column nav-side">
                ...
                <Nav.Item>
                  ...
                  <Nav.Link
                    ...
                    // disabled={handleDisabledMenu("branch-office")}
                  >
                    <div>
                ...
                <Nav.Item>
                  <Nav.Link
                    eventKey="system-administrator"
                    disabled={handleDisabledMenu("system-administrator")}
                  >
                    <div>
                ...
                <Nav.Item>
                  <Nav.Link
                    eventKey="setting"
                    disabled={handleDisabledMenu("setting")}
                  >
                    <div>
                ...
                <Nav.Item>
                  <Nav.Link
                    eventKey="mark-up"
                    disabled={handleDisabledMenu("mark-up")}
                  >
                    <div>
                ...
                <Nav.Item>
                  <Nav.Link
                    eventKey="service-fee"
                    disabled={handleDisabledMenu("service-fee")}
                  >
                    <div>
                ...
                <Nav.Item>
                  <Nav.Link
                    eventKey="ancillary-fee"
                    disabled={handleDisabledMenu("ancillary-fee")}
                  >
                    <div>
                ...
                <Nav.Item>
                  <Nav.Link
                    eventKey="assign-team"
                    // disabled={handleDisabledMenu("assign-team")}
                  >
                    <div>
                ...
                <Nav.Item>
                  <Nav.Link
                    eventKey="credit-limit"
                    disabled={handleDisabledMenu("credit-limit")}
                  >
                    <div>
                ...
                <Nav.Item>
                  <Nav.Link
                    eventKey="invoice-settings"
                    disabled={handleDisabledMenu("invoice-settings")}
                  >
                    <div>
                ...
                <Nav.Item>
                  <Nav.Link
                    eventKey="corporate-rating"
                    // disabled={handleDisabledMenu("corporate-rating")}
                  >
                    <div>
                ...
                <Nav.Item>
                  <Nav.Link
                    eventKey="corporate-fare"
                    // disabled={handleDisabledMenu("corporate-fare")}
                  >
                    <div>
                ...
                <Nav.Item>
                  <Nav.Link
                    ...
                    disabled={handleDisabledMenu("upload-document")}
                  >
                    <div>
                ...
                <Nav.Item>
                  <Nav.Link
                    eventKey="import-database-employee"
                    disabled={handleDisabledMenu("import-database-employee")}
                  >
                    <div>
              ...
              <Tab.Content>
                ...
                <Tab.Pane eventKey="branch-office">
                  {tabKey === "branch-office" && (
                    <BranchOffice handleChangeTabKey={handleChangeTabKey} />
                  )}
                </Tab.Pane>
                ...
                <Tab.Pane eventKey="import-database-employee">
                  {tabKey === "import-database-employee" && (
