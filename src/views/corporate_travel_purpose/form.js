...
const endpoint = "/master/corporate-travel-purpose"
const backUrl = "/master/corporate-travel-purpose"

function CorporateTravelPurposeForm(props) {
  ...
  const onSave = async () => {
    ...
    try {
      ...
      dispatch(
        setAlert({
          message: `Record ${form.travel_purpose_code} - ${form.travel_purpose_name
...
export default withRouter(CorporateTravelPurposeForm)
