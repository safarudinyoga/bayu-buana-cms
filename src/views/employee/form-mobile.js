...
const EmployeeFormMobile = (props) => {
  ...
  const toggleActiveKey = (key) => {
    setCurrentActiveKey(currentActiveKey === key ? "general-information" : key)
  }
            ...
            <Accordion activeKey={currentActiveKey}>
              <Card className="mb-0">
                <Accordion.Toggle
                  ...
                  style={
                    currentActiveKey === "general-information"
                        ...
                        <div style={{ padding: "0 15px 15px" }}>
                          <FormikControl
                            ...
                            value={
                              sameAddress
                                ...
                                : formik.values.permanent_address.address_line
                            }
                            onChange={() => {
                          ...
                          <FormikControl
                            ...
                            value={
                              sameAddress
                                ? formik.values.address.postal_code
                                : formik.values.permanent_address.postal_code
                            }
                          />
                        </div>
                      </Col>
              ...
              <Card className="mb-0">
                <Accordion.Toggle
                  ...
                  style={
                    currentActiveKey === "emergency-contacts"
                      ? { backgroundColor: "#dddddd", color: "#038072" }
                      : null
                  }
                  onClick={() => {
