            ...
            birth_date: data.birth_date
              ? [
                  ...
                  },
                  {
                    ...
                    label: new Date(
                      null,
                      parseInt(data.birth_date.split("-")[1]),
                      null,
                      ...
                      <Form.Group as={Row} className="form-group">
                        ...
                        <Col md={9} lg={8}>
                          <div style={{ maxWidth: 300, display: "flex" }}>
                            <div
                              style={{ marginRight: 12, maxWidth: 60, flex: 1 }}
                            >
                              <Select
                                options={selectDay(
                                  values.birth_date[1],
                    ...
                    <Col sm={9}>
                      <div style={{ maxWidth: 200 }}>
                        <Select
                          ...
                          placeholder="Please choose"
                          options={
                            values.permanentCountry === null
                              ? []
                              : selectPermanentProvince
                          }
                          onChange={(v) => {
