...
const EmergencyContacts = (props) => {
  ...
  useEffect(async () => {
    try {
      let res = await api.get("/master/agent-corporate")
      let data = res.data
      setIntialForm({
        ...initialForm,

        // Emergency Contact 1
        fullNameEmergency1: data.emergency_contact.contact_name
          ? data.emergency_contact.contact_name
          : "",
        phoneNumberEmergency1: data.emergency_contact.contact_phone_number
          ? data.emergency_contact.contact_phone_number
          : "",
        relationshipEmergency1: data.emergency_contact.relationship
          ? data.emergency_contact.relationship
          : "",

        // Emergency Contact 2
        fullNameEmergency2: data.emergency_contact2.contact_name
          ? data.emergency_contact2.contact_name
          : "",
        phoneNumberEmergency2: data.emergency_contact2.contact_phone_number
          ? data.emergency_contact2.contact_phone_number
          : "",
        relationshipEmergency2: data.emergency_contact2.relationship
          ? data.emergency_contact2.relationship
          : "",
      })
    } catch (e) {}
  }, [])
    ...
    <Formik
      ...
      onSubmit={async (values, { setSubmitting, resetForm }) => {
        ...
        try {
          ...
          openSnackbar(`Your profile has been successfully updated.`)
        } catch (e) {}
