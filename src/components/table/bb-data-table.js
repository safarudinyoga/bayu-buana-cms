  ...
  init() {
    ...
    columns.push( isShowColumnAction ? {
      ...
      render: function (value, display, row, meta) {
        ...
        return (
          `
          <a href="javascript:void(0);" data-toggle="tooltip" data-placement="${placement}" class="table-row-action-item ${hideDetail ? "mr-2" : ""}" data-action="edit" data-id="${module == 'partner-hotel-suppliers' ? row.hotel_supplier_id: row.id}" title="Click to edit"><img src="${editIcon}"/></a>
