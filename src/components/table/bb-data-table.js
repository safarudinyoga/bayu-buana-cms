    ...
    columns.push({
      ...
      render: function (val, display, row) {
        return (
          ...
          row.id +
          '" class="float-left select-checkbox-item ml-2"/> <a class="float-left d-md-none" style="padding: 0; color: #b7b7b7"><i class="fas fa-plus-circle" style="font-size: 17px;padding-left: 8px"></i></a>'
        )
      },
    })
