    ...
    columns.push( isShowColumnAction ? {
      ...
      render: function (value, display, row, meta) {
        ...
        return (
          ...
          ${
            showCopyAct ? (
              `<a href="javascript:void(0);" data-toggle="tooltip" data-placement="${placement}" class="table-row-action-item ${hideDetail ? "mr-2" : ""}" data-action="edit" data-id="${targetDataId}" title="Click to copy"><i class="fas fa-copy"></i></a>`
            ) : ""
          }
