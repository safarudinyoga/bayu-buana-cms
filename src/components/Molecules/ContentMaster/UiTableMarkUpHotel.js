...
function createData(destination, applyCondition, markUp, actions) {
  return {
    destination,
    applyCondition,
    markUp,
...
function UiTableMarkUpHotel({ titleButton, linkButton }) {
    ...
    <div>
      <div className={classes.controlTable}>
        ...
        <Grid item sm={3} className={classes.itemEnd}>
          ...
          <ModalCreateMarkUpHotel setFunc={setOpen} open={open} />
        </Grid>
      </div>
...
export default UiTableMarkUpHotel;
