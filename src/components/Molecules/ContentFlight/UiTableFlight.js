...
const rows = [
  ...
  createData('Mexico', 'MX', 126577691, 1972550, <IconsUiTable />),
  createData('Japan', 'JP', 126317000, 377973, <IconsUiTable />),
  createData('France', 'FR', 67022000, 640679, <IconsUiTable />),
  createData('United Kingdom', 'GB', 67545757, 242495, <IconsUiTable />),
  createData('Russia', 'RU', 146793744, 17098246, <IconsUiTable />),
  createData('Nigeria', 'NG', 200962417, 923768, <IconsUiTable />),
  createData('Brazil', 'BR', 210147125, 8515767, <IconsUiTable />),
];
...
function UiTableFlight({ titleButton, linkButton }) {
